      ...
      {isSubmitting && (
        <div className="fixed inset-0 z-[300] flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="bg-white rounded-lg shadow-xl p-8 mx-4 max-w-sm w-full text-center">
            ...
            <p className="text-lg font-semibold text-gray-900 mb-2">Submitting your application...</p>
            <p className="text-sm text-gray-500">We're checking your submission. This may take a few minutes — please do not close or navigate away from this page.</p>
          </div>
        </div>
      )}
